<template>
  <div class="widget-main">
    <div :class="{'open-social': activeBtn}" class="social-block">
      <div class="social-wrap">
        <nuxt-link class="bh-telegram" target="_blank" to="https://telegram.me/petkitsales">
          <img alt="button-icon"
               class="bh-button-icon"
               src="data:image/svg+xml,%3csvg width='24' height='24' fill='none' xmlns='http://www.w3.org/2000/svg'%3e%3cpath d='m22.81 2.952-3.568 18.215s-.153.832-1.186.832c-.548 0-.831-.26-.831-.26l-7.728-6.413-3.78-1.905L.863 12.13S0 11.88 0 11.166c0-.595.889-.879.889-.879l20.3-8.065S21.81 2 22.262 2c.278 0 .595.119.595.476 0 .238-.047.476-.047.476z' fill='white'/%3e%3cpath d='m12.381 17.719-3.263 3.213s-.142.11-.331.115a.472.472 0 0 1-.209-.041l.918-5.681 2.885 2.394z' fill='%23C8D2D7'/%3e%3cpath d='M18.95 5.996a.476.476 0 0 0-.668-.088l-12.568 7.52s2.006 5.612 2.312 6.583c.306.973.552.996.552.996l.918-5.681 9.364-8.663a.475.475 0 0 0 .09-.667z' fill='%23E4EAEC'/%3e%3c/svg%3e">
        </nuxt-link>
        <nuxt-link class="bh-whatsapp" target="_blank" to="https://wa.me/message/GNSFF6YLQ3BNM1">
          <img alt="button-icon"
               class="bh-w-button-icon"
