    ...
    <div class="prod-descr">
      ...
      <div class="prod-descr-price">
        <div class="product-prices">
          <div v-if="product.fields.oldPrice" class="price-cur-old">{{ product.fields.oldPrice }}<span>MDL</span></div>
          <div class="price-cur">{{ product.fields.price }}<span>MDL</span></div>
        </div>
