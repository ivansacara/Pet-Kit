  ...
  <div class="prod-item">
    ...
    <div class="info-wrap">
      ...
      <div class="prod-prices">
        <div v-if="product.fields.oldPrice" class="prod-price-old">{{ product.fields.oldPrice }}<span>MDL</span></div>
        <div class="prod-price">{{ product.fields.price }}<span>MDL</span></div>
      </div>
